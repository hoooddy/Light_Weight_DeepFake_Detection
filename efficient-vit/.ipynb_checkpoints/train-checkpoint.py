...
if __name__ == "__main__":
    ...
    # for t in range(starting_epoch, opt.num_epochs):
        ...
        train_loss_list.append(round(total_loss, 4))
        ...
        val_f1_score_list.append(round(val_f1_score))  # 검증 F1 score 리스트에 추가

        print(train_loss_list)
        print(val_loss_list)
        print(lr_list)
        print(train_f1_score_list)
        print(val_f1_score_list)
