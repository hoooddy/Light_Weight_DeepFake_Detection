...
# device = "cpu"
MODELS_DIR = "result/2024-12-13_04-41-08" # cross efficient vit
# MODELS_DIR = "result/2024-12-20_20-13-32" # CNN epoch 50
# MODELS_DIR = "result/2024-12-21_14-10-55" # CNN epoch 200
...
MODEL_PATH = os.path.join(MODELS_DIR, "efficientnetB0.pt")
...
def plot_confusion_matrix(labels_list, preds, labels=['Real', 'Fake']):
...
if __name__ == "__main__":
    ...
    for folder in folders:
        ...
        subfolder = os.listdir(method_folder)
        
        for index, video_folder in enumerate(subfolder[:len(subfolder)]):
    ...
    plot_confusion_matrix(test_labels_list, test_preds)
...
Model_Name: Cross-Efficient-ViT
