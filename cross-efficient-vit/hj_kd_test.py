...
# device = "cpu"
# MODELS_DIR = "result/2024-12-20_20-13-32" # epoch 50
MODELS_DIR = "result/2024-12-21_01-09-55" # epoch 200
BASE_DIR = "../../../deep_fakes"

DATA_DIR = os.path.join(BASE_DIR, "dataset")
TEST_DIR = os.path.join(DATA_DIR, "test_set")
RESULT_PATH = os.path.join(MODELS_DIR, "test_result")
MODEL_PATH = os.path.join(MODELS_DIR, "kd-cross-efficient-vit.pt")
...
if __name__ == "__main__":
    ...
    videos_counters = collections.Counter(image[1] for image in videos)
    print(videos_counters)
